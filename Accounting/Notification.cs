...
namespace Accounting
{
    public partial class Notification : Form
    {
        ...
        private void Notification_Load(object sender, EventArgs e)
        {
            ...
            string query1= "SELECT a.borrowRequestId,b.itemName,CONCAT(a.qty, ' ', a.measureType) AS qty,CONCAT(studentFName, ' ', studentLName) AS student, c.schoolId,c.yearCourse,"+
            "a.borrowedDate,a.returnDate, CONCAT(e.firstname, ' ', e.lastname) AS releasedBy,a.remarks,c.studentId"+
           " FROM chem_lab.borrowing a INNER JOIN administrativeassociate e ON a.releasedBy = e.admin_ID,"+
            ...
            " AND c.studentID = a.studentId AND a.requestStatus = 'Released' AND a.returnDate < NOW()";
            ...
            dataGridView2.Columns["returnDate"].HeaderText = "Expected Date Returned";
            dataGridView2.Columns["remarks"].HeaderText = "Remarks";
            dataGridView2.Columns["releasedBy"].Visible=false;
        }
    }
}
